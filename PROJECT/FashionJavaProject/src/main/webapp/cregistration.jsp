                        ...
                        <div id="feedback_form_container">    
                            <form class="row contact_form" action="CustomerController" method="post" novalidate="novalidate">
                               <div class="col-lg-12">
                                ...
                                <div class="col-lg-12">
                                    <input type="text" class="form-control" id="messge" name="address" 
                                        placeholder="Enter Addreess">
                                </div>
                                <div class="col-lg-12">
                                    <input type="text" class="form-control" id="messge" name="city" 
                                        placeholder="Enter City">
                                </div>
                                <div class="col-lg-12">
                                    <input type="text" class="form-control" id="messge" name="pincode" 
                                        placeholder="Enter Pincod">
                                </div>
                                <div class="col-lg-12">
                                    <input type="tel" class="form-control" id="messge" name="mobile" 
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <button align="center" type="submit" value="register" name="action" class="btn_3">
                                        REGISTER
                                    </button>
                                    </form>
                                </div>
