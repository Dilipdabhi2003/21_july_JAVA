				...
				<div class="col-lg-6 col-md-6">
					<div class="contact__text">
						<div class="section-title">
							...
							<h1>Welcome Back!</h1>
							<h3>
								<label>OTP Send On Email Address</label>
							</h3>
							<h5>
								&emsp;
								<%=email%></h5>
