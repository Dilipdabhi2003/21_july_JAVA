                        ...
                        <div class="row g-9">
                            ...
                            <div class="col-md-12">
                                <div class="form-floating">
                                    <label for="email">Enter New Password</label><input type="text" class="form-control" id="email" name="newpassword" placeholder="">
                                 ...
                                 <div class="col-md-12">
                                <div class="form-floating">
                                   <label for="email">Enter New Confirm Password</label> <input type="text" class="form-control" id="email" name="Cpassword" placeholder="">
